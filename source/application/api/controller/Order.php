...
class Order extends Controller
{
    ...
    public function buyNow()
    {
        ...
        // dump($this->user['wxapp_id']);die;
        reward($this->user['user_id'],$orderInfo['order_price'],$Checkout->model['order_id'],10,$this->user['wxapp_id']);            //分佣金(1-用户id 2-商品总金额(不含运费) 3-订单id 4-订单类型 5-wxapp_id)
        // 返回状态
        // 返回结算信息
