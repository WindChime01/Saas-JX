                        ...
                        <fieldset>
                            ...
                            <div class="panel-grade__content <?= $model['is_enable_grade'] == '0' ? 'hide' : '' ?>">
                                ...
                                <div class="panel-grade-alone__content <?= $model['is_alone_grade'] == '0' ? 'hide' : '' ?>">
                                    <div class="am-form-group">
                                        <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">选择折扣类型</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[alone_grade_type]" value="10"
                                                   data-am-ucheck
                                                <?= $model['alone_grade_type'] == 10 ? 'checked' : '' ?>>
                                            百分比
                                        </label>
                                        <label class="am-radio-inline">
                                            <input type="radio" name="goods[alone_grade_type]" value="20"
                                                   data-am-ucheck
                                                <?= $model['alone_grade_type'] == 20 ? 'checked' : '' ?>>
                                            固定金额
                                        </label>
                                    </div>
                                </div>
                                        <label class="am-u-sm-3 am-u-lg-2 am-form-label"> </label>
                                        <div class="bfb am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                            <!-- 会员等级列表-->
                                            <?php foreach ($gradeList as $item): ?>
                                                <div class="am-input-group am-margin-bottom-sm">
                                                    ...
                                                    <input type="number" class="bfb am-form-field"
                                                           ...
                                                           min="0" required>
                                                    <span class="widget-dealer__unit am-input-group-label am-input-group-label__right"><?= ($model['alone_grade_type']==10?'折':'元') ?></span>
                                                </div>
                                            <?php endforeach; ?>
                                            <div class="help-block">
...
<script>
    $(function () {
        ...
        $("input:radio[name='goods[alone_grade_type]']").change(function (e) {
            $('.widget-dealer__unit').text(e.currentTarget.value === '10' ? '折' : '元');
        });
