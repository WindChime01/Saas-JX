                        ...
                        <div class="am-tabs am-margin-top" data-am-tabs="{noSwipe: 1}">
                            ...
                            <div class="am-tabs-bd">
                                <div class="am-tab-panel am-active am-margin-top-lg" id="tab1">
                                    ...
                                    <!--            一级分销-->
                                    <!--        </label>-->
                                    <!--        <label class="am-radio-inline level">-->
                                    <!--            <input type="radio" name="setting[basic][level]"-->
                                ...
                                <div class="am-tab-panel am-margin-top-lg" id="tab2">
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <label class="am-radio-inline" onclick="javascript:auto_register(10)">
                                                <input type="radio" name="setting[condition][become]"
                                                       value="10" data-am-ucheck
                                                    <?= $data['condition']['values']['become'] == '10' ? 'checked' : '' ?>>
                                                需后台审核
                                            </label>
                                            <label class="am-radio-inline" onclick="javascript:auto_register(20)">
                                                <input type="radio" name="setting[condition][become]"
											...
											<!-- 小宝 -->
											<label class="am-radio-inline hide" onclick="javascript:auto_register(30)">
                                                <input type="radio" name="setting[condition][become]"
                                                       value="30" data-am-ucheck
                                                    <?= $data['condition']['values']['become'] == '30' ? 'checked' : '' ?>>
                                                自动注册（仅支持一级分销）
                                            </label>
                                        </div>
                                    </div>
                                    <div class="am-form-group register">
                                    ...
                                    <div class="am-form-group am-padding-top register">
...
<script>
    $(function () {
		...
		auto_register($("input[name='setting[condition][become]']:checked").val());
    });
	function auto_register(v){
		if(v == 30){
			$('.register').addClass('hide');
			$(":radio[name='setting[basic][level]'][value='1']").prop("checked", "checked");
			$('.level').addClass('hide');
		}else{
