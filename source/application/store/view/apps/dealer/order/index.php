                ...
                <div class="widget-body am-fr">
                    ...
                    <div class="page_toolbar am-margin-bottom-xs am-cf">
                        <form class="toolbar-form" action="">
                            ...
                            <span style="position:absolute;padding-top:5%">分销总金额(不含取消订单或退款单):<?=$money?></span>
                            <div class="am-u-sm-12 am-u-md-9 am-u-sm-push-3">
                                <div class="am fr">
                                    ...
                                    <div class="am-form-group am-fl">
                                        <select name="is_settled" data-am-selected="{btnSize: 'sm', placeholder: '全部'}">
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($i === 1) : $goodsCount = count($order['order_master']['goods']); ?>
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                ...
                                                <?php if (!!$order['is_invalid']) : ?>
                                                    <span class="am-badge am-badge-warning">订单已取消或已退款</span>
                                                <?php endif; ?>
                                                <?php endif; ?>
                                            </td>
                                        <?php endif; ?>
                                        ...
                                        <div class="dealer am-cf">
                                            <?php if ($order['first_user_id'] > 0): ?>
                                                <div class="dealer-item am-fl am-margin-right-xl">
                                                    <p>
                                                        <span class="am-text-right">分销商：</span>
