                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 是否只能后台设置 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="grade[backstage]" value="0" data-am-ucheck
                                            <?= $model['backstage'] == '0' ? 'checked' : '' ?>>
                                        否
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="grade[backstage]" value="1" data-am-ucheck
                                            <?= $model['backstage'] == '1' ? 'checked' : '' ?>>
                                        是
                                    </label>
                                    <div class="help-block">
                                        <small></small>
                        ...
                        <div class="panel-grade__content <?= $model['backstage'] == '1' ? 'hide' : '' ?>">
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <div class="am-input-group">
                                        ...
                                        <input type="number" name="grade[upgrade]"
                                               value="<?= $model['upgrade'] ?>"
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <div class="am-input-group">
                                        <span class="am-input-group-label am-input-group-label__left">利率</span>
                                        <input type="number" name="grade[commission]" class="am-form-field"
                                              value="<?= $model['commission'] ?>" max="100" min="0" required>
                                        <span class="widget-dealer__unit am-input-group-label am-input-group-label__right">%</span>
                                    </div>
                                    <div class="help-block">
                                        <small>利率范围0-100，20代表20%，0代表无利率</small>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
...
<script>
    $(function () {
        ...
        $("input:radio[name='grade[backstage]']").change(function (e) {
            $panelGrade.toggle();
        });
    });
</script>
